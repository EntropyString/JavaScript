...
test('Char Set Base 64 Strings', () => {
  ...
  expect(
    entropy.stringWithBytes([0xd9, 0x39, 0xc1, 0xaf, 0x1e, 0x2e, 0x69, 0x48], 60)
  ).toBe('2TnBrx4uaU')
  expect(
    entropy.stringWithBytes([0x78, 0x3f, 0xfd, 0x93, 0xd1, 0x06, 0x90, 0x4b, 0xd6], 66)
  ).toBe('eD_9k9EGkEv')
  expect(
    entropy.stringWithBytes([0x9d, 0x99, 0x4e, 0xa5, 0xd2, 0x3f, 0x8c, 0x86, 0x80], 72)
  ).toBe('nZlOpdI_jIaA')
})
